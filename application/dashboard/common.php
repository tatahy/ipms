...
const conAssStatusOprtArr=[
                      ...
                      ['status'=>'_ASSS4_3','statusChi'=>'待销账_报废','oprt'=>['_APPROVE','_TRASH'],'nextStatus'=>[]],
                      ['status'=>'_ASSS4_4','statusChi'=>'待销账_遗失','oprt'=>['_UPDATE','_APPROVE','_TRASH'],'nextStatus'=>[]],
...
const conAssOprtChangeStatusArr=[
                        ...
                        ['oprt'=>'_SUBMIT','oprtChi'=>'提交','statusChangeTo'=>['待分配_初次验收合格','待分配_维修验收合格','异常_待更新','异常_待维修','异常_遗失']],
                        ['oprt'=>'_AUDIT','oprtChi'=>'审核','statusChangeTo'=>['正常_折旧中','正常_折旧完','停用_封存','停用_维修中']],
                        ['oprt'=>'_APPROVE','oprtChi'=>'审批','statusChangeTo'=>['待销账_报废','待销账_遗失']],
