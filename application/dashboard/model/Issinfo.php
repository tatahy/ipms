 ...
 */
    ...
    /**
     * 定义模型关联方法patList(),获取对应patent的内容，与Patinfo模型关联，是多对一的关联关系
     * 关联方法得到的数据呈现的是类似['pat_list'=>[]]的数组。
     * 即是TP5框架同时将驼峰命名的模型关联方法视为模型的一个属性，有数据输出时属性名转换为带下划线的对应名称。
     * 要想上述关联方法名与属性名保持一致，就用全小写命名关联方法名。
     */
