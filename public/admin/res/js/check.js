...
$.idcode = {
    ...
    validateCode: function(option) {
		...
		//JavaScript的toUpperCase()方法把字符串转换为大写。
...
function _setCodeStyle(eid, codeType, codeLength) {
	...
	//利用JavaScript的Math对象方法floor()结合random()返回0~5之间的随机整数
...
// 生成验证码中每个字符及其颜色的HTML代码（颜色在列举的值中随机选定，验证码字符串由参数指定）
