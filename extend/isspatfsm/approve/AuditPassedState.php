...
class AuditPassedState extends ApproveState{
  ...
  public function permit(){
    ...
    $data['iss']['info']['statusdescription']='批准申报';
  ...
  public function complete(){
    ...
    //$data['iss']['record']['actdetail']='<p>《'.$data['iss']['info']['topic'].'》<span class="label label-warning">修改完善</span></p><span class="text-warning">修改意见：</span><pre>'.$data['iss']['info']['statusdescription'].'</pre>';
    $data['iss']['record']['actdetail']='0';
    //数据表“issrecord”的“actdetailhtml”字段存储结构化的信息（模型“issrecord”设置自动转换为json类型），便于前端组装HTML进行显示。
    $data['iss']['record']['actdetailhtml']=array(
                                                'p'=>array(
